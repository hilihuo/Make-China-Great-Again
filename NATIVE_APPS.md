...
```powershell
Get-FileHash -Algorithm SHA256 '.\release\android\China-Humanities-Museum-1.0.1.apk'
```

使用 Android Build Tools 验证 APK 签名：

```powershell
apksigner verify --verbose --print-certs '.\release\android\China-Humanities-Museum-1.0.1.apk'
```
